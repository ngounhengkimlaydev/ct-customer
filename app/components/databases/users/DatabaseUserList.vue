        ...
        <div class="mt-4 space-y-3 border-t border-default pt-4">
          <div>
            ...
            <div class="mt-2 flex flex-wrap gap-1.5">
              <UBadge v-for="database in item.assignedDatabases" :key="database" color="neutral" variant="soft"
                size="sm">
                {{ database }}
              </UBadge>
            </div>
          ...
          <div>
            ...
            <div class="mt-2 flex flex-wrap gap-1.5">
              <UBadge v-for="privilege in item.privileges" :key="privilege" color="primary" variant="soft" size="sm">
