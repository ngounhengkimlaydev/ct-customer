<template>
  <div class="space-y-6">
    ...
    <GitProviderCards :providers="providers" @connect="connectProvider" />

    <GitImportProjectCard v-model:search="search" v-model:selected-repo="selectedRepo" :repositories="repositories"
      :filtered-repositories="filteredRepositories" :visible-repositories="visibleRepositories"
      :has-more-repositories="hasMoreRepositories" :form="form" :branch-options="branchOptions"
      :framework-options="frameworkOptions" :submitting="isImporting" @cancel="cancelImport" @import="importProject"
